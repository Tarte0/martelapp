...
public class AnalyseGraphe3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_analyse_graphe3);
         ...
         */
        TableLayout tableau_coupe_essence = findViewById(R.id.tableau_volume_categorie_diametre);
        ...
        for(int i = 0; i < 4; i++) {
            ...
            for (int j = 0; j < row.length; j++) {
                TextView text = createTextView(i == 3, j == row.length - 1);
                text.setText(row[j]);
                if (j == 0) {
                    text.setTypeface(null, Typeface.BOLD);
                }
        ...
        PieChart pieChart = findViewById(R.id.pie_chart_volume_categorie_diametre);
